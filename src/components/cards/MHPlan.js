                ...
                return (
                    ...
                    <br></br>
                        ...
                        <div style={{marginLeft: "15px"}}>
                            ...
                            <div><b>Physical symptoms :</b><br></br><div style={{marginLeft:'20px'}}>{physicalList}</div></div>
                            <div><b>Behaviour symptoms :</b><br></br><div style={{marginLeft:'20px'}}>{behaviourList}</div></div>
                            <div><b>Mood symptoms :</b><br></br><div style={{marginLeft:'20px'}}>{moodList}</div></div>
                            <div><b>Sleep symptoms :</b><br></br><div style={{marginLeft:'20px'}}>{sleepList}</div></div>
                            <div><b>Manic/Hypomanic symptoms :</b><br></br><div style={{marginLeft:'20px'}}>{manicList}</div></div>
                            <div><b>Eating disorder symptoms :</b><br></br><div style={{marginLeft:'20px'}}>{eatingList}</div></div>
                            <div><b>Sexuality:</b><br></br><div style={{marginLeft:'20px'}}>{sexualityList}</div></div>
                        </div>
                        <br></br>
                        ________________________________________________________________________________________
                        <h3>Childhood History</h3>
                        <div style={{marginLeft: "15px"}}>
                            <div><b>Learning difficulties:</b><br></br><div style={{marginLeft:'20px'}}>{learningList}</div></div>
                            <div><b>Autism symptoms:</b><br></br><div style={{marginLeft:'20px'}}>{autismList}</div></div>
                            <div><b>ADHD/ADD symptoms:</b><br></br><div style={{marginLeft:'20px'}}>{adhdList}</div></div>
                        </div>
                        <br></br>
                        ________________________________________________________________________________________
                        <h3>Past Mental Health History</h3>
                        <div style={{marginLeft: "15px"}}>
                            <div><b>Past Diagnosis:</b><br></br><div style={{marginLeft:'20px'}}> {pasthistoryList}</div></div>
                            <div><b>Past Treatment:</b><br></br><div style={{marginLeft:'20px'}}> {pasttreatmentList}</div></div>
                        </div>
                        <br></br>
                        ________________________________________________________________________________________
                        <h3>Medication History</h3>
                        <div style={{marginLeft: "15px"}}>
                            <div><b>Current Medications:</b><br></br><div style={{marginLeft:'20px'}}>{currentmedList}</div></div>
                            <div><b>Past Medications:</b><br></br><div style={{marginLeft:'20px'}}>{pastmedList}</div></div>
                        </div>
                        <br></br>
                        ________________________________________________________________________________________
                        <h3>Family History</h3>
                        <div style={{marginLeft: "15px"}}>
                            <div><b>Family History:</b><br></br><div style={{marginLeft:'20px'}}>{familyhistoryList}</div></div>
                            <div><b>Children at home:</b><br></br><div style={{marginLeft:'20px'}}>{childrenList}</div></div>
                        </div>
                        <br></br>
                        ________________________________________________________________________________________
                        <h3>Social History</h3>
                        <div style={{marginLeft: "15px"}}>
                            <div><b>Employment:</b><br></br><div style={{marginLeft:'20px'}}>{employmentList}</div></div>
                            <div><b>Substance Use:</b><br></br><div style={{marginLeft:'20px'}}>{substanceList}</div></div>
                            <div><b>Living arrangement:</b><br></br><div style={{marginLeft:'20px'}}>{livingList}</div></div>
                            <div><b>Financials:</b><br></br><div style={{marginLeft:'20px'}}>{financialList}</div></div>
                            <div><b>Social Supports:</b><br></br><div style={{marginLeft:'20px'}}>{supportList}</div></div>
                        </div>
                        <br></br>
                        ________________________________________________________________________________________
                        <h3>Risk</h3>
